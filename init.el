...
;; set org-mode font
(setq doom-variable-pitch-font (font-spec :family "Hack Nerd Font" :size 16))
...
(setq doom-themes-neotree-file-icons t) ; if you use doom-themes
(setq neo-theme 'icons) ; set the NeoTree theme to icons
